...
public class ProductsAssertionTest {
    ...
    public void test0014() {
        response.body("data.name", hasItems("Duracell - AAA Batteries (4-Pack)", "Duracell - AA Batteries (8-Pack)", "Energizer - MAX Batteries AA (4-Pack)"));
    }
    ...
    public void test0020() {
        response.body("data.findAll{it.id == 346575}.categories.size()", equalTo(1));
    }
